...
class ForecastAdapter : RecyclerView.Adapter<ForecastAdapter.ViewHolder>() {
    ...
    private val differCallback=object : DiffUtil.ItemCallback<ForecastResponseApi.WeatherListItem>() {
        override fun areItemsTheSame(
            oldItem: ForecastResponseApi.WeatherListItem,
            newItem: ForecastResponseApi.WeatherListItem
        ): Boolean {
